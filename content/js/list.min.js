...
$(function() {
	...
	$.getJSON( "/js/data.json", function(searchValues) {
		var options = {
			listClass: 'search-list',
	  		valueNames: [ 't', 'v', 'u' ],
	  		plugins: [ ListFuzzySearch() ],
	  		item: '<li><a href="" class="u"><p class="t"></p></a></li>'
		};

		userList = new List('lista', options, searchValues);
	});
});

function searchShow() {
	$('.search-wrapper').removeClass('dosearch');
	setTimeout(function(){
...
function searchHide() {
	...
	setTimeout(function(){
		$('.search-wrapper').addClass('dosearch');
		$('.search-field').val('');
	}, 500);
}
